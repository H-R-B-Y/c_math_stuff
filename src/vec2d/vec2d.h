...
/*   Updated: 2025/04/04 13:19:36 by hbreeze          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param vec Pointer to the vector to be rotated.
 ...
 * @param vec Pointer to the vector to be reflected.
 ...
 * @param vec1 Pointer to the vector to be projected.
 ...
 * @param vec Pointer to the vector to be clamped.
