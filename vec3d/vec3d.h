...
/*   Updated: 2025/04/03 21:21:35 by hbreeze          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct __attribute__((aligned(8))) s_vec3
{
	MYFLOAT	x;
	MYFLOAT	y;
	MYFLOAT	z;
 ...
 * @param vec Pointer to the vector to clamp.
 ...
 * @param start Pointer to the start vector.
 * @param end Pointer to the end vector.
 ...
 * @param vec Pointer to the vector to project.
 * @param onto Pointer to the vector onto which the projection is done.
 ...
 * @param vec Pointer to the vector to reflect.
 ...
 */
t_vec3		vec3_rotate(t_vec3 *vec, MYFLOAT angle, t_vec3 *axis);
